...
const SearchExercises = ({
  ...
  //   Fetch exercise categories as soon as our page loads.
  //   Leaving our dependency array empty because we want to call the useEffect function once our page loads
  useEffect(() => {
  ...
  const handleSearch = async () => {
    if (search) {
      ...
      setSearch(""); //clear the search first
